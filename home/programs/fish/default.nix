...
in
{
  programs.fish = {
    ...
    # any-nix-shell is used in interactiveShellInit; add it here to ensure
    # it's always available in PATH, even if software.defaults.enable changes
    ...
    # ssh: only for fish running in Kitty/Ghostty (not all shells)
    # other aliases: docker, system tools that are fish-native
    shellAliases = {
